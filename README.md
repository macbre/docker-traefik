...
[Dockerized](https://hub.docker.com/_/traefik/tags) [`traefik v3`](https://github.com/traefik/traefik) with auto-discovery of other containers on the same Docker network.
